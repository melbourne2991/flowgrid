...
function calculateInputDimensions(i: number): PortPositionData {
  return {
    x: inPortXOffset,
...
function calculateOutputDimensions(i: number): PortPositionData {
  return {
    x: outPortXOffset,
    y: i * nodeRowHeight + nodeRowOffset,
    text: {
...
const dimensionCalculations: InputOutputPortPositionDataMap = {
  input: calculateInputDimensions,
  output: calculateOutputDimensions
};
